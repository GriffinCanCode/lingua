"""Unit 1 Vocabulary Factory - Aggregates all PoS files into unified vocab."""
...
# PoS file mappings - order matters for loading
POS_FILES = {
    "pronouns": "pronouns.yaml",
    "nouns": "nouns.yaml",
    "verbs": "verbs.yaml",
    "adjectives": "adjectives.yaml",
    "adverbs": "adverbs.yaml",
    "numerals": "numerals.yaml",
    "particles": "particles.yaml",
    "conjunctions": "conjunctions.yaml",
    "interjections": "interjections.yaml",
...
@lru_cache(maxsize=1)
def get_meta() -> dict:
    """Load unit metadata and pronunciation quirks."""
...
@lru_cache(maxsize=1)
def get_pronunciation_quirks() -> list:
    """Get pronunciation quirks/rules."""
    meta = get_meta()
    return meta.get("pronunciation_quirks", [])
...
def clear_cache():
    ...
    get_pronunciation_quirks.cache_clear()
